/**
 * Copy-paste from https://github.com/acornjs/acorn/issues/814
 * Thanks to blutorange
 */
declare module 'acorn-walk' {
  ...
  type FullWalkerCallback<TState> = (node: import('estree').Node, state: TState, type: NodeType) => void;
